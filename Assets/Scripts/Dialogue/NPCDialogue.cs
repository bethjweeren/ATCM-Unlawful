        ...
        if (Characters.IsSuspect(id))
        {
            ...
            if (DialogueSystem.Instance().blueIsKiller)
            {
                ...
                switch (id)
                {
                    case CharacterID.BLACK:
                        ...
                        clueResponses.Add("BLACKOPPORTUNITYGREEN", new ClueEntry("I didn't see him that night, mayhaps he was squirrled away in his winery?", "[Black] said: He didn't see [Green] that night.", "blackDidntSeeGreen"));
                    ...
                    case CharacterID.BLUE:
                        ...
                        clueResponses.Add("BLUEMOTIVERED", new ClueEntry("%(sigh)% Geez, why should I know? | I guess I saw [Victim] purchasing supplies from [Red] each time he was in town.  %It's not like I'm her keeper or anything%", "[Blue] said: [Victim] often purchased supplies from [Red].", "blueSupplierRed"));
                        ...
                        clueResponses.Add("yellowSawBlue", new ClueEntry("W-what?  Just because I was in the town square doesn't mean anything. %other than that I should've kept a better eye out.% | I got drunk by mid-evening anyway, so she must've seen me earlier in the night during my last rounds.", "[Blue] said: The murder must have happened after he made his rounds for the night.", "blueRoundsBlue"));
                    ...
                    case CharacterID.GREEN:
                        ...
                        clueResponses.Add("GREENMOTIVEBLUE", new ClueEntry("A visit from [Victim] seems to calm everyone down.  Naturally, [Blue] seems laziest during [Victim]'s visits. | I doubt that he loathes the ... days off.", "[Blue] enjoys slacking when [Victim] visits.", "greenSlackBlue"));
                        //Motive Responses
                    ...
                    case CharacterID.YELLOW:
                        ...
                        clueResponses.Add("YELLOWOPPORTUNITYBLUE", new ClueEntry("Hmm, I believe I saw [Blue] patrolling the town square on my walk home that night. But that's normal, isn't it?", "[Yellow] said: She saw [Blue] patrolling town square that night.", "yellowSawBlue"));
                        //Opportunity Responses
            ...
            else
            {
                ...
                switch (id)
                {
                    case CharacterID.BLACK:
                        //Motive
                        clueResponses.Add("motive", new ClueEntry("[Victim] was... less than religious.  I believe he was a fool to reject the Lord. | Look where that landed him.", "[Black] blames [Victim]'s death on his rejection of religion.", "blackReligionBlack"));

                        clueResponses.Add("BLACKMOTIVEGREEN", new ClueEntry("Would you truly expect a critic of alcohol and a vintner to get along?", "[Black] thinks: [Green] the vintner is at odds with [Victim] the critic of wine.", "blackClashGreen"));
                        clueResponses.Add("BLACKMOTIVEYELLOW", new ClueEntry("Even those who do not follow the Lord must find solace in something. | Her comfort was found in [Victim] tending to her husband until the end.", "[Black] thinks: [Yellow] appreciated [Victim] taking care of her husband until his death.", "blackHusbandYellow"));
                        clueResponses.Add("BLACKMOTIVERED", new ClueEntry("I understand her... disdain for [Victim].  She is a child of the Lord, and [Victim] has publicly denouced religion. | What would you do if someone publicly denouced your way of life?", "[Black] thinks: [Red] dislikes [Victim] for denouncing religion.", "yellowReligionRed"));
                        clueResponses.Add("BLACKMOTIVEBLACK", new ClueEntry("[Victim] was... less than religious.  I believe he was a fool to reject the Lord. | Look where that landed him.", "[Black] blames [Victim]'s death on his rejection of religion.", "blackReligionBlack"));
                        clueResponses.Add("BLACKMOTIVEBLUE", new ClueEntry("I would be surprised to find out that [Blue] would want [Victim] gone. | He would have to work twice as much to deal with the citizens stressed by the loss of their most consistent doctor.", "[Black] thinks: [Blue] misses the security of having a doctor if things go wrong.", "greenSlackingBlue"));
                        //Motive Responses
                        clueResponses.Add("blueAngryBlack", new ClueEntry("[Victim] was... less than religious.  I believe he was a fool to reject the Lord. | Look where that landed him.", "[Black] said: [Black] believes that [Victim] was a fool to reject religion.", "blackReligionBlack"));
                        clueResponses.Add("greenHeadacheBlack", new ClueEntry("%(sigh)% Of course I was calmed when [Victim] visited.  I cannot hate a fellow saver of lives. | However, I stand by my word; he was a fool to hate the Lord.", "[Black] thinks: [Black] believes that [Victim] was a fool to reject religion.", "blackReligionBlack"));
                        clueResponses.Add("redLikedBlack", new ClueEntry("%(sigh)% Of course I was calmed when [Victim] visited.  I cannot hate a fellow saver of lives. | However, I stand by my word; he was a fool to hate the Lord.", "[Black] thinks: [Black] believes that [Victim] was a fool to reject religion.", "blackReligionBlack"));
                        clueResponses.Add("yellowHeadacheBlack", new ClueEntry("%(sigh)% Of course I was calmed when [Victim] visited.  I cannot hate a fellow saver of lives. | However, I stand by my word; he was a fool to hate the Lord.", "[Black] thinks: [Black] believes that [Victim] was a fool to reject religion.", "blackReligionBlack"));

                        //Opportunity
                        clueResponses.Add("opportunity", new ClueEntry("As a servent of the Lord, I must continually reconnect with Him. | I dedicated that night to this aim by committing myself to deep prayer in the church all night.", "[Black] says he stayed in the church all that night.", "blackDevotionalBlack"));

                        clueResponses.Add("BLACKOPPORTUNITYGREEN", new ClueEntry("I didn't see him that night.  Mayhaps he was squirrled away in his winery?", "[Black] didn't see [Green] that night.", "blackDidntSeeGreen"));
                        clueResponses.Add("BLACKOPPORTUNITYYELLOW", new ClueEntry("All the lights were off at her bakery that night, and she only shuts off the lights in her store when she leaves it. | Now that I think about it, I actually saw her heading to [Location] during a break from my devotional.", "[Black] saw [Yellow] walking away from [Location] that night.", "blueDidntSeeYellow"));
                        clueResponses.Add("BLACKOPPORTUNITYRED", new ClueEntry("I had hoped to speak with [Red] before I went into my devotion, but she was nowhere to be found. | She must have been out for the night, but I could not imagine where.", "[Black] didn't see [Red] that night.", "blackDidntSeeRed"));
                        clueResponses.Add("BLACKOPPORTUNITYBLACK", new ClueEntry("As a servent of the Lord, I must continually reconnect with Him. | I dedicated that night to this aim by committing myself to deep prayer in the church all night.", "[Black] says he stayed in the church all that night.", "blackDevotionalBlack"));
                        clueResponses.Add("BLACKOPPORTUNITYBLUE", new ClueEntry("A man in his position should know to be more cautious with where he sleeps.  He was passed out.", "[Black] saw [Blue] passed out that night.", "blackDidntSeeBlue"));
                        //Opportunity Responses
                        clueResponses.Add("blueSawBlack", new ClueEntry("People are saying that I was out? | The night of [Victim]'s murder, I was having a devotional through the night at the center of the church. | I do not pretend to understand how anyone could misconstrue that.", "[Black] said: [Black] was having a devotional in the Church that night.", "blackDevotionalBlack"));
                        clueResponses.Add("greenSawBlack", new ClueEntry("The night of [Victim]'s murder, I was having a devotional through the night at the center of the church.", "[Black] said: [Black] was having a devotional in the Church that night.", "blackDevotionalBlack"));
                        clueResponses.Add("redDidntSeeBlack", new ClueEntry("People are saying that I was out? | The night of [Victim]'s murder, I was having a devotional through the night at the center of the church. | I do not pretend to understand how anyone could misconstrue that.", "[Black] said: [Black] was having a devotional in the Church that night.", "blackDevotionalBlack"));
                        clueResponses.Add("yellowSawBlack", new ClueEntry("The night of [Victim]'s murder, I was having a devotional through the night at the center of the church.", "[Black] said: [Black] was having a devotional in the Church that night.", "blackDevotionalBlack"));
			clueResponses.Add("blackWeapon", new ClueEntry("May the Lord have mercy on [Victim]'s soul. | ...You believe that the Lord's servant would have [Weapon]? | If you must know, child, I do own [Weapon]. | My turn.  Did you know that [Yellow] has [Weapon]?  The Lord sees all.", "[Black] said: [Black] owns [Weapon].", "blackWeapon"));
                        //Weapon
                        clueResponses.Add("means", new ClueEntry("May the Lord have mercy on [Victim]'s soul. | ...You believe that the Lord's servant would have [Weapon]? | If you must know, child, I do own [Weapon].", "[Black] said: [Black] owns [Weapon].", "blackWeapon"));

                        break;
                    case CharacterID.BLUE:
                        //Motive
                        clueResponses.Add("motive", new ClueEntry("With such a small town, folk get paranoid without a local doctor. %especially when sick.% | But when [Victim] was around, everyone calmed down. %saved me so much trouble.%", "[Blue] likes how everyone remained calm when [Victim] was around.", "BLUEMOTIVEBLUE"));

                        clueResponses.Add("BLUEMOTIVEGREEN", new ClueEntry("[Green] liked wine, %who can blame him,% and [Victim] didn't.  What is there to figure out?", "[Blue] thinks: [Green] and [Victim] had differing views on alcohol.", "blueAgainstGreen"));
                        clueResponses.Add("BLUEMOTIVEYELLOW", new ClueEntry("I dunno.  Why are you askin' me about [Yellow]? %not like she talks to me anyway% | Well, she's been a bit colder to me since her husband died.  Maybe she blames [Victim] for his death?", "[Blue] thinks: [Yellow] blames [Victim] for her husband's death.", "blueHusbandYellow"));
                        clueResponses.Add("BLUEMOTIVERED", new ClueEntry("%(sigh)% Geez, why should I know? | I guess I saw [Victim] purchasing supplies from [Red] each time he was in town.  %It's not like I'm her keeper or anything%", "[Blue] thinks: [Victim] was a consistent customer of [Red]'s.", "blueSupplierRed"));
                        clueResponses.Add("BLUEMOTIVEBLACK", new ClueEntry("I think [Victim] gave the old man some news he didn't quite like. | Ever since a particular meeting, [Black] seems too angry for words when [Victim] is brought up.", "[Blue] thinks: [Black] is infuriated by something [Victim] told him.", "blueAngryBlack"));
                        clueResponses.Add("BLUEMOTIVEBLUE", new ClueEntry("With such a small town, folk get paranoid without a local doctor. %especially when sick.% | But when [Victim] was around, everyone calmed down. %saved me so much trouble.%", "[Blue] likes how everyone remained calm when [Victim] was around.", "BLUEMOTIVEBLUE"));
                        //Motive Responses
                        clueResponses.Add("blackDrinkingBlue", new ClueEntry("%here we go.% [Victim] was the only person who could rival [Black] in judginess. | What I do, what I drink, who I spend my time with, he always made a point to comment on them. %at least I get why the friar's doing it.% | Like he's one to talk, pointing his hips at [Yellow] any time she's in the room. | %(sigh)% I love how everything's calm enough to take a day off when he visits, and he seems like a good doctor, but he always got on my nerves when I actually needed a checkup.", "[Blue] said: [Blue] didn't like that [Victim] harassed [Yellow].", "blueHarassYellow"));
                        clueResponses.Add("greenSlackingBlue", new ClueEntry("%here we go.% [Victim] was the only person who could rival [Black] in judginess. | What I do, what I drink, who I spend my time with, he always made a point to comment on them. %at least I get why the friar's doing it.% | Like he's one to talk, pointing his hips at [Yellow] any time she's in the room. | %(sigh)% I love how everything's calm enough to take a day off when he visits, and he seems like a good doctor, but he always got on my nerves when I actually needed a checkup.", "[Blue] said: [Blue] didn't like that [Victim] harassed [Yellow].", "blueHarassYellow"));
                        clueResponses.Add("redJealousBlue", new ClueEntry("[Victim] was a playboy for the ages.  He couldn't keep his hands off of [Yellow]. | I'm not happy that he's dead though. %but at least she won't be harassed anymore.%", "[Blue] said: [Blue] didn't like that [Victim] harassed [Yellow].", "blueHarassYellow"));
                        ...
                        //Opportunity
                        clueResponses.Add("opportunity", new ClueEntry("I was.... I was passed out that night.  The bottle hit me harder than usual.", "[Blue] says that he was passed out drunk that night.", "blueDrunkBlue"));

                        clueResponses.Add("BLUEOPPORTUNITYGREEN", new ClueEntry("I'm not his keeper, but I might have seen [Green] around. | %...was that who I saw?%", "[Blue] can't place [Green] that night.", "blueSawGreen"));
                        clueResponses.Add("BLUEOPPORTUNITYYELLOW", new ClueEntry("I didn't spot her that night.  And believe me, I tried. | ([Blue] shoots you a strange wink)", "[Blue] didn't see [Yellow] that night.", "blueDidntSeeYellow"));
                        clueResponses.Add("BLUEOPPORTUNITYRED", new ClueEntry("I was finishing up my last patrol when I saw her walking toward [Location]. | %she was probably just walking home though.%", "[Blue] saw [Red] walking toward [Location] that night.", "greenSawRed"));
                        clueResponses.Add("BLUEOPPORTUNITYBLACK", new ClueEntry("I'm pretty sure he was where he normally was, in the church. | I guess I didn't see him, but is he's never really anywhere else.", "[Blue] didn't see [Black] that night.", "blueSawBlack"));
                        clueResponses.Add("BLUEOPPORTUNITYBLUE", new ClueEntry("I was.... I was passed out that night.  The bottle hit me harder than usual.", "[Blue] says that he was passed out drunk that night.", "blueDrunkBlue"));
                        //Opportunity Responses
                        clueResponses.Add("blackDidntSeeBlue", new ClueEntry("Huh? %didn't I tell you...?% | I was passed out that night from living it up with some bottles of Green Wine. | I woke up this morning on a bench near the West entrance of town, went home to clean up, and then went back out to work. | I don't know about you, but do my habbits really seem murderous?", "[Blue] said: [Blue] was passed drunk out that night.", "blueDrunkBlue"));
                        clueResponses.Add("greenDidntSeeBlue", new ClueEntry("Huh? %didn't I tell you...?% | I was passed out that night from living it up with some bottles of Green Wine. | I woke up this morning on a bench near the West entrance of town, went home to clean up, and then went back out to work. | I don't know about you, but do my habbits really seem murderous?", "[Blue] said: [Blue] was passed drunk out that night.", "blueDrunkBlue"));
                        clueResponses.Add("redDidntSeeBlue", new ClueEntry("Huh? %didn't I tell you...?% | I was passed out that night from living it up with some bottles of Green Wine. | I woke up this morning on a bench near the West entrance of town, went home to clean up, and then went back out to work. | I don't know about you, but do my habbits really seem murderous?", "[Blue] said: [Blue] was passed drunk out that night.", "blueDrunkBlue"));
                        ...
                        //Weapon
                        clueResponses.Add("means", new ClueEntry("%geez%  I dunno about that, detective. | I bet you want to know if I have something that could've strangled [Victim], huh babe? | I try not to use it, but I do have [Weapon].", "[Blue] owns [Weapon].", "blueWeapon"));
                        //Weapon Responses
                        clueResponses.Add("greenWeaponBlue", new ClueEntry("Don't worry, I wouldn't touch the thing.  Unless you wanted me to, of course. | I actually caught a glimpse of [Yellow] with [Weapon] yesterday.  %but you already knew that, didn't you?% | %smart bastard.%", "[Blue] said: [Blue] does not own [Weapon], but [Yellow] does.", "blueWeaponYellow"));
                        clueResponses.Add("redWeaponBlue", new ClueEntry("Don't worry, I wouldn't touch the thing.  Unless you wanted me to, of course. | I actually caught a glimpse of [Yellow] with [Weapon] yesterday.  %but you already knew that, didn't you?% | %smart bastard.%", "[Blue] said: [Blue] does not own [Weapon], but [Yellow] does.", "blueWeaponYellow"));
                        clueResponses.Add("blueWeapon", new ClueEntry("%geez%  I dunno about that, detective. | I bet you want to know if I have something that could've strangled [Victim], huh babe? | I try not to use it, but I do have [Weapon].", "[Blue] owns [Weapon].", "blueWeapon"));

                        break;
                    case CharacterID.GREEN:
                        //Motive
                        clueResponses.Add("motive", new ClueEntry("[Victim] may have been my personal doctor, but I assure you that it was purely ... out of necessity.", "[Green] used [Victim]'s services out of necessity.", "greenDoctorGreen"));

                        clueResponses.Add("GREENMOTIVEGREEN", new ClueEntry("[Victim] may have been my personal doctor, but I assure you that it was purely ... out of necessity.", "[Green] used [Victim]'s services out of necessity.", "greenDoctorGreen"));
                        clueResponses.Add("GREENMOTIVEYELLOW", new ClueEntry("[Yellow]'s husband was a patient of [Victim].  She seems to have liked him enough to place her husband in his care.", "[Green] thinks: [Yellow] chose [Victim] to care for her husband when he was sick.", "greenHusbandYellow"));
                        clueResponses.Add("GREENMOTIVERED", new ClueEntry("[Red] has a sharp mind when it comes to business. | However, she has trouble keeping opinion and business seperate when it comes to [Victim] and religion, and he often eggs her on.", "[Green] thinks: [Red] and [Victim] often fight over religious views.", "yellowReligionRed"));
                        clueResponses.Add("GREENMOTIVEBLACK", new ClueEntry("Their relationship seemed ... strained at best. | I don't think they ever got along.  Especially with [Victim] publicly denouncing God.", "[Green] thinks: [Black] was angered by [Victim]'s hate of religion.", "yellowReligionRed"));
                        clueResponses.Add("GREENMOTIVEBLUE", new ClueEntry("A visit from [Victim] seems to calm everyone down.  Naturally, [Blue] seems laziest during [Victim]'s visits. | I doubt that he loathes the ... days off.", "[Green] thinks: [Blue] took a day off to relax when [Victim] visited town.", "greenSlackingBlue"));
                        //Motive Responses
                        clueResponses.Add("redExpeditedGreen", new ClueEntry("[Victim] was my personal doctor, and I assure you that it was purely ... out of necessity.", "[Green] said: [Victim] was [Green]'s personal doctor.", "greenDoctorGreen"));
                        clueResponses.Add("yellowExpeditedGreen", new ClueEntry("[Victim] was my personal doctor, and I assure you that it was purely ... out of necessity.", "[Green] said: [Victim] was [Green]'s personal doctor.", "greenDoctorGreen"));
                        clueResponses.Add("blackClashGreen", new ClueEntry("Ah yes.  [Victim]'s \"shows\". | [Victim] is a travelling doctor, but he also had theories that he loved to share.  So he would often claim a stage at a local tavern and speak of his discoveries. | His most recent and most famous \"discovery\" is that wine and alcohol have long-term negative health effects.  He essentially launched a war on alcohol. | However, [Victim] has long been my doctor, and he is luckily professional enough to not speak of it while he visits me, but these shows have cost Green Wine much in the past few years.", "[Green] said: [Victim] was [Green]'s personal doctor.", "greenDoctorGreen"));
                        ...
                        //Opportunity
                        clueResponses.Add("opportunity", new ClueEntry("Actually, I was heading to [Yellow]'s Bakery on the night of the murder. | I'd heard that she wasn't going to the party that night, so I was going to ... meet with her about wine shipments, but she wasn't there so I returned home.", "[Green] says he went to Yellow Bakery and then walked straight home that night.", "greenSawYellow"));

                        clueResponses.Add("GREENOPPORTUNITYGREEN", new ClueEntry("Actually, I was heading to [Yellow]'s Bakery on the night of the murder. | I'd heard that she wasn't going to the party that night, so I was going to ... meet with her about wine shipments, but she wasn't there so I returned home.", "[Green] says he went to Yellow Bakery and then walked straight home that night.", "greenSawYellow"));
                        clueResponses.Add("GREENOPPORTUNITYYELLOW", new ClueEntry("I never ran into her, but an employee saw her near [Location].  Didn't stick around to see her go in though. | Her husband would never have forgotten an appointment.", "[Green]'s employee saw [Yellow] near [Location] that night.", "blueDidntSeeYellow"));
                        clueResponses.Add("GREENOPPORTUNITYRED", new ClueEntry("Leaving the bakery, I saw [Red] with a bag of supplies heading toward [Location].  I believed her to be making commissions at the time.", "[Green] thought he saw [Red] heading toward [Location] that night.", "greenSawRed"));
                        clueResponses.Add("GREENOPPORTUNITYBLACK", new ClueEntry("I had dropped by his church before the party started and saw him in deep prayer. | His devotions tend to last for hours, so I wouldn't consider him a suspect.", "[Green] saw [Black] busy in the church that night.", "greenSawBlack"));
                        clueResponses.Add("GREENOPPORTUNITYBLUE", new ClueEntry("I cannot recall seeing him patrolling, or at all that night, really.", "[Green] didn't see [Blue] that night.", "greenDidntSeeBlue"));
                        //Opportunity Responses
                        clueResponses.Add("blackDidntSeeGreen", new ClueEntry("Actually, I was heading to [Yellow]'s Bakery on the night of the murder. | I was going to ... meet with her about wine shipments, but she wasn't there so I walked straight home.", "[Green] said: [Green] went to Yellow Bakery and then walked straight home that night.", "greenSawYellow"));
                        clueResponses.Add("blueSawGreen", new ClueEntry("I was heading to [Yellow]'s Bakery on the night of the murder. | I'd heard that she wasn't going to the party that night, so I was going to ... meet with her about wine shipments, but she wasn't there so I walked straight home.", "[Green] said: [Green] went to Yellow Bakery and then walked straight home that night.", "greenSawYellow"));
                        clueResponses.Add("redSawGreen", new ClueEntry("I was heading to [Yellow]'s Bakery on the night of the murder. | I'd heard that she wasn't going to the party that night, so I was going to ... meet with her about wine shipments, but she wasn't there so I walked straight home.", "[Green] said: [Green] went to Yellow Bakery and then walked straight home that night.", "greenSawYellow"));
                        ...
                        //Weapon
                        clueResponses.Add("means", new ClueEntry("You wish to know if I own anything that could have ... strangled [Victim]? | Have you any proof, detective?  I do not believe that I own [Weapon], but you seem quite sure. | Since you seem to be ... having trouble, then I will give you the hint you so desire, detective.  [Red] with [Weapon] at Town Square.", "[Green] said: [Green] owns [Weapon] and thinks [Red] does too.", "greenWeaponRed"));

                        break;
                    case CharacterID.RED:
                        //Motive
                        clueResponses.Add("motive", new ClueEntry("I think [Victim] bought things from me just to turn around and charge me for his medical services. | [Victim] wasn't exactly the most curtious of shoppers though.  Always picking apart my worship of God.", "[Victim] was a manipulative and arguative buyer of [Red]'s supplies.", "redMotiveRed"));

                        clueResponses.Add("REDMOTIVEGREEN", new ClueEntry("Feh, [Victim] only served [Green] because he was paid to.  They basically disagreed on everything else.", "[Red] thinks: [Victim] and [Green] didn't like each other but put it aside for business.", "redExpeditedGreen"));
                        clueResponses.Add("REDMOTIVEYELLOW", new ClueEntry("Oh, please.  [Yellow] wouldn't ever \"dislike\" someone.  At least not in a way that a normal person would. | She's just thankful that [Victim] helped her husband until the end.", "[Red] thinks: [Yellow] is thankful to [Victim] for caring for her husband.", "redHusbandYellow"));
                        clueResponses.Add("REDMOTIVERED", new ClueEntry("I think [Victim] bought things from me just to turn around and charge me for his medical services. | [Victim] wasn't exactly the most curtious of shoppers though.  Always picking apart my worship of God.", "[Victim] was a manipulative and arguative buyer of [Red]'s supplies.", "redMotiveRed"));
                        clueResponses.Add("REDMOTIVEBLACK", new ClueEntry("The friar may not like most people, but he can't really complain about someone that's done so much good for the town.", "[Red] thinks: [Black] appreciates the good that [Victim]'s done for the town.", "redLikedBlack"));
                        clueResponses.Add("REDMOTIVEBLUE", new ClueEntry("%Tch.% [Blue] spends his whole day at [Yellow]'s bakery when the doctor's in town. | He must think the doctor's gonna fix everything while he wastes time with [Yellow].", "[Red] thinks: [Blue] relies on [Victim] to care for the town when [Victim] visits.", "redJealousBlue"));
                        //Motive Responses
                        clueResponses.Add("blackSupplierRed", new ClueEntry("Yeah, yeah.  [Victim] was a supplier of mine, if you could call it that. | Just because he brought me stuff doesn't mean he had good intentions though. | Turns out I may have been the only one unable to pay his fees.  So in response, he started supplying me so that I could pay him on his next visits. | I don't mind the supplies, but [Victim]'s got problems.", "[Red] said: [Victim] was a bad customer to [Red].", "redMotiveRed"));
                        clueResponses.Add("greenSupplierRed", new ClueEntry("Yeah, yeah.  [Victim] was a supplier of mine, if you could call it that. | Just because he brought me stuff doesn't mean he had good intentions though. | Turns out I may have been the only one unable to pay his fees.  So in response, he started supplying me so that I could pay him on his next visits. | I don't mind the supplies, but [Victim]'s got problems.", "[Red] said: [Victim] was a bad customer to [Red].", "redMotiveRed"));
                        clueResponses.Add("yellowReligionRed", new ClueEntry("[Victim] wasn't exactly the most curtious of shoppers...  He was always picking apart my worship of God.", "[Red] said: [Victim] was a bad customer to [Red].", "redMotiveRed"));
                        ...
                        //Opportunity
                        clueResponses.Add("opportunity", new ClueEntry("What?  You think I did it? | I couldn't have done it, I was painting outside, nowhere near [Location], to keep from staining my floor.", "[Red] says she was painting away from [Location] that night.", "redOutsideRed"));

                        clueResponses.Add("REDOPPORTUNITYGREEN", new ClueEntry("Fancy pants?  I think I saw him near [Location]'s entrance that night. | I don't tend to keep track of him too much outside of business though.", "[Red] saw [Green] near [Location]'s entrance that night.", "redSawGreen"));
                        clueResponses.Add("REDOPPORTUNITYYELLOW", new ClueEntry("[Yellow]?  Why should I know? | She's the baker, she was probably at the bakery.", "[Red] didn't see [Yellow] that night.", "redSawYellow"));
                        clueResponses.Add("REDOPPORTUNITYRED", new ClueEntry("What?  You think I did it? | I couldn't have done it, I was painting outside, nowhere near [Location], to keep from staining my floor.", "[Red] says she was painting away from [Location] that night.", "redOutsideRed"));
                        clueResponses.Add("REDOPPORTUNITYBLACK", new ClueEntry("I saw him head into church that night.  He must have been doing a devotional that night since he didn't come back out from what I saw.", "[Red] saw [Black] enter and not leave the church that night.", "redDidntSeeBlack"));
                        clueResponses.Add("REDOPPORTUNITYBLUE", new ClueEntry("I didn't see him, though I'd bet he was getting drunk somewhere. | When's that idiot going to shape up?", "[Red] didn't see [Blue] that night.", "redDidntSeeBlue"));
                        //Opportunity Responses
                        clueResponses.Add("blackDidntSeeRed", new ClueEntry("Where'd you get that accusation?  Give me a name! | Well, you know what?  I didn't murder [Victim], because I wasn't in the Town Square. | I got inspired and went out to paint by torchlight in an alley near my house. | I had a view of some entrances, but not the actual square and I have the art to prove it.  Tell my accuser that!", "[Red] said: She was outside painting to avoid staining her floor.", "redOutsideRed"));
                        clueResponses.Add("blueDidntSeeRed", new ClueEntry("Where'd you get that accusation?  Give me a name! | Well, you know what?  I didn't murder [Victim], because I wasn't in the Town Square. | I got inspired and went out to paint by torchlight in an alley near my house. | I had a view of some entrances, but not the actual square and I have the art to prove it.  Tell my accuser that!", "[Red] said: She was outside painting to avoid staining her floor.", "redOutsideRed"));
                        clueResponses.Add("greenSawRed", new ClueEntry("What?  You think I did it?  Of course I didn't do it! | I was outside painting to keep from staining my floor.", "[Red] said: She was outside painting to avoid staining her floor.", "redOutsideRed"));
                        clueResponses.Add("yellowSawRed", new ClueEntry("What?  You think I did it?  Of course I didn't do it! | I was outside painting to keep from staining my floor.", "[Red] said: She was outside painting to avoid staining her floor.", "redOutsideRed"));
			clueResponses.Add("redWeapon", new ClueEntry("%(sigh)% What a mess. | ...Wait, you think that I have [Weapon]? | Yes, I have [Weapon].  Is that really your major breakthrough here?", "[Red] owns [Weapon].", "redWeapon"));

                        //Weapon
                        clueResponses.Add("means", new ClueEntry("%(sigh)% What a mess. | ...Wait, you think that I have [Weapon]? | Yes, I have [Weapon].  Is that really your major breakthrough here?", "[Red] owns [Weapon].", "redWeapon"));

                        break;
                    case CharacterID.YELLOW:
                        //Motive
                        clueResponses.Add("motive", new ClueEntry("[Victim] seemed like a kind man.  However, %and pardon my bluntness, honey,% [Victim] was not a good doctor. | He is what we had though.  I doubt anyone is looking forward to the upcoming months without a doctor.", "[Yellow] thinks [Victim] is a bad doctor.", "yellowHusbandYellow"));

                        clueResponses.Add("YELLOWMOTIVEGREEN", new ClueEntry("I don't know about their personal life, but I know that [Victim] only comes into town when [Green] expedites him. | [Green] must really prefer [Victim] to be his doctor.  Don't you think, honey?", "[Yellow] thinks: [Green] likes [Victim] if [Green] pays to expedite him.", "yellowExpeditedGreen"));
                        clueResponses.Add("YELLOWMOTIVEYELLOW", new ClueEntry("[Victim] seemed like a kind man.  However, %and pardon my bluntness, honey,% [Victim] was not a good doctor. | He is what we had though.  I doubt anyone is looking forward to the upcoming months without a doctor.", "[Yellow] thinks [Victim] is a bad doctor.", "yellowHusbandYellow"));
                        clueResponses.Add("YELLOWMOTIVERED", new ClueEntry("I really shouldn't say anything, but... | Well, [Victim] was a very outspoken atheist, and you know [Red], hot tempered and religious. | I can't imagine their conversations lasted long or ended well.", "[Yellow] thinks: [Red] and [Victim] fought over conflicting views on religion.", "yellowReligionRed"));
                        clueResponses.Add("YELLOWMOTIVEBLACK", new ClueEntry("Ah, yes, the friar didn't seem to have any major problems with [Victim]. | In fact, he seemed less sour than usual when [Victim] was in town.  Probably took some of the stress of death off his mind.", "[Yellow] thinks: [Black] was calmed to have a doctor in town.", "yellowHeadacheBlack"));
                        clueResponses.Add("YELLOWMOTIVEBLUE", new ClueEntry("Oh, that [Blue].  His face turns red as an apple pie when he sees [Victim] at my bakery. | [Victim] seems very respectful and is always such a sweetie to me.  I can't imagine why [Blue] wouldn't like him.", "[Blue] is jealous of [Victim].  [Yellow] thinks: [Blue] has no reason to dislike [Victim].", "yellowFaceBlue"));
                        //Motive Responses
                        clueResponses.Add("greenHusbandYellow", new ClueEntry("[Victim] seemed like a kind man.  However, %and pardon my bluntness, honey,% [Victim] was not a good doctor. | He is what we had though.  I doubt anyone is looking forward to the upcoming months without a doctor.", "[Yellow] said: [Yellow] thinks that [Victim] was a bad doctor.", "yellowHusbandYellow"));
                        clueResponses.Add("redHusbandYellow", new ClueEntry("[Victim] seemed like a kind man.  However, %and pardon my bluntness, honey,% [Victim] was not a good doctor. | He is what we had though.  I doubt anyone is looking forward to the upcoming months without a doctor.", "[Yellow] said: [Yellow] thinks that [Victim] was a bad doctor.", "yellowHusbandYellow"));
                        clueResponses.Add("blackHusbandYellow", new ClueEntry("[Victim] seemed like a kind man.  However, %and pardon my bluntness, honey,% [Victim] was not a good doctor. | He is what we had though.  I doubt anyone is looking forward to the upcoming months without a doctor.", "[Yellow] said: [Yellow] thinks that [Victim] was a bad doctor.", "yellowHusbandYellow"));
                        clueResponses.Add("blueHusbandYellow", new ClueEntry("[Victim] seemed like a kind man.  However, %and pardon my bluntness, honey,% [Victim] was not a good doctor. | He is what we had though.  I doubt anyone is looking forward to the upcoming months without a doctor.", "[Yellow] said: [Yellow] thinks that [Victim] was a bad doctor.", "yellowHusbandYellow"));
                        //Opportunity
                        clueResponses.Add("opportunity", new ClueEntry("I went to the graveyard that night, dearie.  I hadn't been to see Mr. [Yellow] in some time, afterall.", "[Yellow] says she was at the graveyard that night.", "yellowGraveyardYellow"));

                        clueResponses.Add("YELLOWOPPORTUNITYGREEN", new ClueEntry("I was supposed to meet [Green] that night, but I forgot and went to the graveyard instead. | As I was finishing up, I saw him walking near [Location].  By the time I'd finished up I didn't see if he'd went in or not. | Oh dear, will that get him in trouble?", "[Yellow] saw that [Green] didn't walk through [Location] on his way home.", "yellowDidntSeeGreen"));
                        clueResponses.Add("YELLOWOPPORTUNITYYELLOW", new ClueEntry("I went to the graveyard that night, dearie.  I hadn't been to see Mr. [Yellow] in some time, afterall.", "[Yellow] says she was at the graveyard that night.", "yellowGraveyardYellow"));
                        clueResponses.Add("YELLOWOPPORTUNITYRED", new ClueEntry("Hm, [Red]?  I don't believe I saw her that night, but I didn't pass through [Location], so if she wasn't home, then maybe she was there?", "[Yellow] didn't see [Red] that night.", "yellowSawRe"));
                        clueResponses.Add("YELLOWOPPORTUNITYBLACK", new ClueEntry("Oh dearie, I don't believe I saw [Black] at all that night.  I figured he'd turned in early.", "[Yellow] didn't see [Black] that night.", "yellowSawBlac"));
                        clueResponses.Add("YELLOWOPPORTUNITYBLUE", new ClueEntry("I did not see [Blue] that night.  Sorry if that's not helpful, honey.", "[Yellow] didn't see [Blue] that night.", "yellowSawBlu"));
                        //Opportunity Responses
                        clueResponses.Add("blackSawYellow", new ClueEntry("Yes, it's true that I was at the graveyard that night.  I hadn't been to see Mr. [Yellow] in some time...", "[Yellow] said: [Yellow] was visiting her husband's grave at the Graveyard that night.", "yellowGraveyardYellow"));
                        clueResponses.Add("blueDidntSeeYellow", new ClueEntry("Oh dear! Someone thinks that I could have done it? What a terrible thing to say! | I closed up shop a bit late after finishing cooking for the party that night, and then walked directly to the Graveyard before it got late. | Time flew while I was there, so I was there most of the night. I went home the long way to the West of the Town Square late that night.", "[Yellow] said: [Yellow] was visiting her husband's grave at the Graveyard that night.", "yellowGraveyardYellow"));
                        clueResponses.Add("greenSawYellow", new ClueEntry("Yes, it's true that I was at the graveyard that night.  I hadn't been to see Mr. [Yellow] in some time...", "[Yellow] said: [Yellow] was visiting her husband's grave at the Graveyard that night.", "yellowGraveyardYellow"));
